       ...
       <!-- Logo -->
        <a href="home.php" class="logo">
          ...
          <span class="logo-mini">
            <object data="lala.jpg" type="jpg" width="50" height="50">
              <!-- fallback untuk browser yang tidak support SVG -->
              <img src="lala.jpg" alt="Logo Mini" width="50" height="50">
            </object>
          </span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">
            <object data="lala.jpg" type="jpg" width="100" height="50">
              <!-- fallback untuk browser yang tidak support SVG -->
              <img src="lala.jpg" alt="Logo Large" width="50" height="50">
            </object>
          </span>
        </a>
      ...
      <div class="content-wrapper">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Dashboard Administrator <span class="logo-lg"><b>LAU</b>NDRY</span></h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <h4>Informasi Personal</h4>
                        <p>Admin: Zaki Indomie </p>
                        <p>toko: Ngawi Laundry </p>
                        <p>alamat : Ngawi</p>
                    </div>
                    <div class="col-md-3">
                        <h4>Kontak</h4>
                        <p>No HP: +626666666666</p>
                        <p>No HP Operator: +626666666666</p>
                    </div>
                </div>
            </div>
        </div>
